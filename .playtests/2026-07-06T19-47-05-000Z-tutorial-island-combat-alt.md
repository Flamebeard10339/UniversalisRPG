# Playtest: tutorial-island-combat-alt
...
> Chose: `action:entity.copper-rock.mine` — Mine Copper
...
> Chose: `action:entity.tin-rock.mine` — Mine Tin
...
Visible choices:
- `action:entity.furnace.smelt@smelt-bronze` (entity-action on furnace): Copper Ore
...
> Chose: `action:entity.furnace.smelt@smelt-bronze` — Copper Ore
...
Entities present (3): Furnace, Anvil, Forge Table
Visible choices:
- `action:entity.anvil.smith@smith-dagger` (entity-action on anvil): Bronze Bar
- `action:entity.forge-table.return-mine` (entity-action on forge-table): Return
- `action:entity.forge-table.continue` (entity-action on forge-table): Continue

> Chose: `action:entity.anvil.smith@smith-dagger` — Bronze Bar
...
> Chose: `action:entity.orloth.fight` — Fight

  - Orloth laughs, trains you hard, and locks the empty cage behind him. Your health does not thank you for it.
...
Visible choices:
- `action:entity.orloth.talk` (entity-action on orloth): Talk
- `action:entity.rat-cage-door.unlock-orloth` (entity-action on rat-cage-door): Unlock
- `action:entity.portal.step-through` (entity-action on portal): Step Through

> Chose: `action:entity.rat-cage-door.unlock-orloth` — Unlock

  - The cage is empty except for Orloth, arms crossed, unimpressed with your priorities.
...
Flags: {"death-count":0,"tutorial-guide.q1.count":0,"tutorial.miki-cleared":true,"tutorial.bridge-open":true,"tutorial.gommi-asleep":false,"tutorial.bank-visited":false,"tutorial.mining-cleared":true,"tutorial.combat-cleared":true,"tutorial.cage-locked-by-orloth":true,"tutorial.reached-mainland":true,"quest.leave-tutorial-island.accepted":true,"well-fed":false}
Inventory: {"emberleaf":0,"log":0,"iron-ore":0,"bones":0,"bronze-spear":0,"bronze-dagger":1,"bronze-arrow":0,"bronze-throwing-knife":0,"tutorial-blade":0,"bronze-pickaxe":1,"gold":5,"lockpick":1,"guide-book":1,"small-net":1,"raw-shrimp":0,"cooked-shrimp":2,"herb":0,"bowl":1,"uncooked-sleeping-draught":0,"sleeping-draught":0,"copper-ore":0,"tin-ore":0,"bronze-bar":0,"iron-dagger":0}
Bank: {}
