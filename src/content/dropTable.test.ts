    ...
    expect(results).toEqual([
      {
        ...
        rows: [
          ...
          {
            weight: 5,
            results: [{ kind: 'give', item: 'coins', amount: { min: 20, max: 20 } }],
          },
          {
            weight: 1,
            results: [
...
describe('# droptable', () => {
  const TABLES = ['# droptable rare-drop', 'one of:', '  128x: nothing', '  1x: give: 1 gem', '# droptable rat-common', 'give: 1 bones', '1 in 3: give: 12 coins'];
