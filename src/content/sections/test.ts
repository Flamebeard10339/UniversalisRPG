  ...
  grammar: {
    lines: {
      forms: [
        'run: <test>',
        'talk: <entity>',
        'choose: <what the choice reads>',
        'use: <kind>.<id>.<action>',
        'use: <action> on <entity>',
        'travel: <location>',
        'goto: <location>',
        'craft: <recipe>',
        'begin: use <kind>.<id>.<action>',
        'begin: travel <location>',
        'begin: craft <recipe>',
        'assert: <condition>',
        'expect: <save>',
        'load: <save>',
        ...
        'unequip: <slot>',
        'feed: <item> with <item>',
        'slot: <item> at <q>,<r> <direction> with <jewel>',
        'allocate: <item> at <q>,<r> position <n>',
        'allocate: <item> at <q>,<r> slot <direction>',
        'apply: <item> at <q>,<r> with <effect>',
        'refuse: <the growth directive that must not take>',
        'open-modal: <modal>',
        'submit-modal: <key>=<value>',
      ],
      examples: [
        'run: opening',
        'talk: guide',
        ...
        'goto: camp',
        'craft: plank',
        'begin: use item.rusty-sword.swing',
        'begin: travel camp',
        'begin: craft plank',
        'assert: has-key',
        'expect: after-intro',
        ...
        'allocate: cluster-jewel at 0,0 slot ne',
