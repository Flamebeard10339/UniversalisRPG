...
export const SubmitToGitHub = ({ appVersion, bundle, draft, validationIssues, t }: SubmitToGitHubProps) => {
  ...
  return (
    <section className="grid gap-3 grid-rows-[auto_auto_1fr] h-full rounded border border-slate-700 p-3 pt-4">
      <div>
      ...
      <textarea className="min-h-0 rounded bg-slate-950 p-3 text-xs text-slate-300 overflow-y-auto" readOnly value={issueBody} />
    </section>
  );
};
