...
import { locationSchema } from '../structuredData/contentSchemas';
...
export const LocationFields = ({ bundle, location, onChange, onRemove, t }: {
  ...
  <section className="grid gap-3 rounded bg-slate-950 p-3">
    <StructuredDataEditor onChange={(value) => { if (value) onChange(value as unknown as LocationNode); }} schema={locationSchema(bundle)} t={t} value={location as unknown as StructuredValue} />
