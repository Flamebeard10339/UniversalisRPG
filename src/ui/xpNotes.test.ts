...
import { emptyQueue, gainsBetween, NOTE_LIFETIME_MS, NOTE_SPACING_MS, poured, queued, risesOf, type Gain } from './xpNotes';
...
describe('how often a line may begin', () => {
  ...
  it('does not drop what landed inside it: the wait joins the next line', () => {
    ...
    expect(titles(next.shown[1].rises)).toEqual([[5, ['Defence', 'Health']]]);
  });
